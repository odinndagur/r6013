...
*/
        ...
        Module['onRuntimeInitialized'] = function onRuntimeInitialized() {
            ...
            var sqlite3_close_v2 = cwrap('sqlite3_close_v2', 'number', [
                'number',
            ])
            ...
            var sqlite3_data_count = cwrap('sqlite3_data_count', 'number', [
                'number',
            ])
            ...
            var sqlite3_finalize = cwrap('sqlite3_finalize', 'number', [
                'number',
            ])
            ...
            var sqlite3_value_type = cwrap('sqlite3_value_type', 'number', [
                'number',
            ])
            var sqlite3_value_bytes = cwrap('sqlite3_value_bytes', 'number', [
                'number',
            ])
            var sqlite3_value_text = cwrap('sqlite3_value_text', 'string', [
                'number',
            ])
            var sqlite3_value_blob = cwrap('sqlite3_value_blob', 'number', [
                'number',
            ])
            ...
            var sqlite3_result_null = cwrap('sqlite3_result_null', '', [
                'number',
            ])
    ...
    */
     ...
     */
            Statement.prototype['getAsObject'] = function getAsObject(
                params,
                config
            ) {
     ...
     */
            ...
            Statement.prototype.bindNumber = function bindNumber(num, pos) {
                ...
                var bindfunc =
                    num === (num | 0) ? sqlite3_bind_int : sqlite3_bind_double
    ...
    @nodoc
     */
            Statement.prototype.bindFromObject = function bindFromObject(
                valuesObj
            ) {
                var that = this
     ...
     */
            ...
            if (
                ...
                StatementIterator.prototype[Symbol.iterator] =
                    function iterator() {
                        return this
                    }
            }
            ...
            function Database(data, { filename = false } = {}) {
                if (filename === false) {
                    this.filename =
                        'dbfile_' + ((0xffffffff * Math.random()) >>> 0)
    ...
    */
                    ...
                    while (getValue(nextSqlPtr, 'i8') !== NULL) {
                        ...
                        if (pStmt !== NULL) {
                            ...
                            while (stmt['step']()) {
                                ...
                                curresult['values'].push(
                                    stmt['get'](null, config)
                                )
                            }
                            stmt['free']()
                        }
     ...
     */
            ...
            Database.prototype['iterateStatements'] =
                function iterateStatements(sql) {
    ...
    @nodoc
     */
            Database.prototype['handleError'] = function handleError(
                returnCode
            ) {
                var errmsg
    ...
    */
    ...
    @param {boolean=} dontAddNull */
        ...
        /** @type {function(...*):?} */
        var _sqlite3_normalized_sql = (Module['_sqlite3_normalized_sql'] =
            createExportWrapper('sqlite3_normalized_sql'))
        ...
        /** @type {function(...*):?} */
        var _RegisterExtensionFunctions = (Module[
            '_RegisterExtensionFunctions'
        ] = createExportWrapper('RegisterExtensionFunctions'))

        /** @type {function(...*):?} */
        var _register_for_idb = (Module['_register_for_idb'] =
            createExportWrapper('register_for_idb'))
